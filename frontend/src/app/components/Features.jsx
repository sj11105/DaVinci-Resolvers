    ...
    <div className='text-black -mt-[165px]' >
      ...
      <div className='mt-[100px]'>
        <ul className='flex-row md:flex'>
          ...
          Congratulations on your pregnancy! We are thrilled to accompany you on this incredible journey to parenthood. At MummaCare, we understand that every pregnancy is unique and filled with moments of joy, anticipation, and sometimes uncertainty. Our mission is to provide you with the support, information, and community you need to navigate this beautiful chapter of your life.
