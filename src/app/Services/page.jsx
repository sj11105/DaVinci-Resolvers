  ...
  return (
    ...
    <div id='services' className='mt-[300px] bg-orange-100 h-[1000px] rounded-tr-full w-[100vw]'>
      ...
      <div className='mt-[90px] ml-[20px]'>
       <Link href="/KnowDiet"><button className='bg-black rounded-xl text-white p-4'>Know Your Diet</button></Link>
        <p className='mt-4'>"Every bite counts—make it nutritious and beneficial for your baby."</p>
      </div>
      <div className='mt-[90px] ml-[20px]'>
       <Link href="/KnowDiet"><button className='bg-black rounded-xl text-white p-4'>Get Your Daily plan</button></Link>
        <p className='mt-4'>"Every bite counts—make it nutritious and beneficial for your baby."</p>
      </div>
      <div className='mt-[90px] ml-[20px]'>
       <Link href="/KnowDiet"><button className='bg-black rounded-xl text-white p-4'>Exercise</button></Link>
        <p className='mt-4'>"Every bite counts—make it nutritious and beneficial for your baby."</p>
      </div>
